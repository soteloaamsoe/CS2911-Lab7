...
def http_server_setup(port):
    ...
    try:
        while True:
            ...
            #request_handler = threading.Thread(target=handle_request, args=(request_socket,))   #non-debug, multi-thread
            # Start the request handler thread.
            #request_handler.start() #non-debug, multi-thread
            handle_request(request_socket)  #debug, single-thread
